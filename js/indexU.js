...
function aceptar(tipo) {
    ...
    if (tipo == 'editar') {
        ...
        url = 'https://rest-soft1.herokuapp.com/unidadmedida/actualizar/' + id
        type = "put"
    } else if (tipo == 'agregar') {
        url = 'https://rest-soft1.herokuapp.com/unidadmedida/agregar'
        type = "post"
    }
...
function eliminar() {
    const id = $("#unidadMedidaID").val();
    $.ajax({
        url: "https://rest-soft1.herokuapp.com/unidadmedida/eliminar/" + id,
        type: "DELETE",
        dateType: "JSON",
        success: function(retorno) {
            location.reload();
...
function cargardatos() {
    ...
    var fila = "";
    $.ajax({
        url: "https://rest-soft1.herokuapp.com/unidadesmedida",
        data: {},
        type: "GET",
        dateType: "JSON",
        success: function(retorno) {
                    ...
                    fila += `
                        <tr Class="table table-success" style="text-align:left ;"> 
                            ...
                            <td> 
                                ...
                                <a href="javascript:deletefunction(${ element["unidadMedidaID"] })" class="btn btn-outline-danger text-uppercase font-weight-bold ml-2">
                                    <i class="icon-cancel">
                                    </i>Eliminar
                                </a>
                            </td>
